...
public abstract class Champion implements Comparable, Damageable  {
	...
	private championListener champListener;

	
	public void setChampListener(championListener champListener) {
		this.champListener = champListener;
	}
	
	public void choose() {
		
		//informs listener , if any champion has been choosen
		
		if(champListener!= null) {
			champListener.onChoose(this);
		}
	}
	...
	public String toString() {
		return "Name: " + getName() +","
				+ "mana: " + getMana() + ", attackRange: "  + getAttackRange() + " , attack damage:"
				+ getAttackRange() +" , speed" + getSpeed() + " , action points: " + getCurrentActionPoints()+ " ,currentHP: " 
				+ getCurrentHP()  ;
